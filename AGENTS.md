...
| Optimizer UI | `src/components/optimizer/` — `shared.tsx`, `ResultCards` (effective-stats preview via `deriveEmblemLoadoutImpact`), `BasicOptimizer`, `AdvancedOptimizer`, `advanced/SearchPoolCard.tsx`, `advanced/ModeEffortCard.tsx`, other `advanced/*Card.tsx` |
